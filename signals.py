...
def score_signal(df: pd.DataFrame, htf_trend: str = "neutral") -> dict:
    ...
    # History: started at 0.03 (too loose — real losses happened at 0.03%
    # and 0.04%). Raised to 0.08 (too strict — produced near-zero signals
    # even during London/NY overlap, the day's most active window).
    # Settled at 0.055 as a middle ground: clearly above the two known
    # losses, but not so high it blocks nearly everything.
    MIN_VOLATILITY_PCT = 0.055
